...
curl -X POST -H "Content-Type: application/json" --data-binary @query/update_by_query.json http://localhost:9200/$target_index/_update_by_query?refresh=true > /dev/null &
sleep 50
